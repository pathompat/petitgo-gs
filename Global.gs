...
// line shopping
const LINE_SHOPPING_BASE_PATH = env('LINE_SHOPPING_BASE_PATH')
const LINE_SHOPPING_TOKEN = env('LINE_SHOPPING_TOKEN')
...
const INVENTORY_SNAP_SHEET = env('INV_SNAP_SHEET')
